...
export const GRUPOS_ATAJOS: Grupo[] = [
  {
    ...
    atajos: [
      ...
      { teclas: ["Alt", "2"], desc: "Caja" },
      { teclas: ["Alt", "3"], desc: "Historial" },
      { teclas: ["Alt", "4"], desc: "Entradas" },
      { teclas: ["Alt", "5"], desc: "Stock" },
      { teclas: ["Alt", "6"], desc: "Etiquetas" },
      { teclas: ["Alt", "7"], desc: "Emprendedores" },
      { teclas: ["Alt", "8"], desc: "CRM" },
